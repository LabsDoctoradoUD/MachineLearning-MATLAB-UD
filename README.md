...
Este repositorio contiene el material práctico del **Taller de Machine Learning con MATLAB**, orientado a la comunidad académica interesada en **aprendizaje automático aplicado**.
...
### Objetivo general
Introducir los fundamentos y la aplicación práctica del Machine Learning supervisado utilizando MATLAB como entorno de experimentación.
...
- Entrenar y comparar modelos usando herramientas gráficas de MATLAB.
